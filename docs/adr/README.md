...
ADRs are point-in-time records of durable choices, not pull-request summaries or implementation inventories. When a decision changes, add a new ADR and mark the old one as superseded instead of rewriting history.
